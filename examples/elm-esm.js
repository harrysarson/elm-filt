...
var author$project$Config$copyableStages = elm$core$Set$fromList(
	_List_fromArray(
		[0, 2, 3]));
var author$project$Types$ToggleInfo = {$: 'ToggleInfo'};
...
var author$project$DisplayPanel$menuView = function (props) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						'.image-display > div:nth-child(' + (elm$core$String$fromInt(props.stage + 1) + ') > *')),
				...
				_List_fromArray(
					[
						elm$html$Html$Events$onClick(author$project$Types$ToggleInfo)
					]),
				_List_fromArray(
					[
...
var author$project$Types$CloseInfo = {$: 'CloseInfo'};
var elm$html$Html$h1 = _VirtualDom_node('h1');
var elm$html$Html$p = _VirtualDom_node('p');
var elm$html$Html$section = _VirtualDom_node('section');
var author$project$InfoPanel$view = A2(
	elm$html$Html$div,
	_List_fromArray(
		[
			elm$html$Html$Attributes$class('information-panel')
		]),
	_List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$html$Html$text('Information about primenumber')
						])),
					A2(
					elm$html$Html$p,
					_List_Nil,
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$html$Html$Events$onClick(author$project$Types$CloseInfo)
						]),
					_List_fromArray(
						[
...
var author$project$DisplayPanel$view = function (props) {
	var menuProps = {stage: props.stage};
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
					...
					A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$class('image-display')
									]),
								A2(
									elm$core$List$map,
									elm$html$Html$div(
								...
								author$project$DisplayPanel$menuView(menuProps)
							]))),
					props.showingInfo ? elm$core$Maybe$Just(author$project$InfoPanel$view) : elm$core$Maybe$Nothing
				])));
};
